...
info <- read.delim("~/Desktop/SwitchDrive/OBIWAN/PROBA_LEARNING/info_expe.txt", header = T, sep ='') # read in dataset
...
# --------------
#   [1] intervention + subjID                                  : 0.5596734  ±0.62%
# [2] Session + subjID                                       : 0.3686278  ±0.85%
# [3] intervention + Session + subjID                        : 0.2227715  ±7.99%
# [4] intervention + Session + intervention:Session + subjID : 0.06922296 ±1.01%
# 
# Against denominator:
#   n ~ subjID 

#frequentist
frqaov <- aov_car(n ~ Session*intervention + Error (subjID/Session), data = df, anova_table = list(correction = "GG", es = "pes")); frqaov

# Anova Table (Type 3 tests)
# 
# Response: n
# Effect    df     MSE    F  pes p.value
# 1         intervention 1, 19 3061.61 0.59 .030    .452
# 2              Session 1, 19 3077.65 0.06 .003    .809
# 3 intervention:Session 1, 19 3077.65 0.31 .016    .587
